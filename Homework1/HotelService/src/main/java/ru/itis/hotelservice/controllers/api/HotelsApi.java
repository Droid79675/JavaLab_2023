...
public interface HotelsApi {
    ...
    @Operation(summary = "Получение списка отелей по имени города.", description = "Доступно всем пользователям")
    @ApiResponses(value = {
    ...
    ResponseEntity<List<HotelDto>> getHotels(
            @Parameter(description = "Имя города", example = "Москва") @RequestParam("cityName") String cityName);
